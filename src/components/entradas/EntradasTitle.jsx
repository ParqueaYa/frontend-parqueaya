...
export function EntradasTitle() {
    return (
        <div className="relative max-w-[800px] mb-6 overflow-hidden group">
            {/* Contenedor Principal con estilo de panel industrial */}
            <div className="bg-slate-900 border border-slate-800 p-5 shadow-xl flex items-center gap-4">

                {/* Indicador Vertical de Estado (Naranja/Primary) */}
                ...
                <div className="flex flex-col">
                    ...
                    {/* Subtítulo decorativo para darle profundidad */}
                ...
                {/* Icono decorativo de fondo (sutil) */}
            ...
            {/* Línea de acento inferior que recorre el ancho */}
